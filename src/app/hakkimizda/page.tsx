        ...
        <>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid lg:grid-cols-2 gap-20 items-center mb-32">
                        <div className="order-2 lg:order-1 relative">
                            ...
                            <img src="/images/traditional-harvest.png" alt="Geleneksel Hasat" className="relative rounded-[60px] shadow-2xl border border-white/10" />
                        </div>
                        <div className="order-1 lg:order-2">
                            ...
                            <div className="flex gap-6">
                                <div className="p-8 bg-white/5 rounded-[40px] border border-white/5 flex-1 text-center backdrop-blur-sm">
                                ...
                                <div className="p-8 bg-gold-400/10 rounded-[40px] border border-gold-400/20 flex-1 text-center backdrop-blur-sm">
                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                            ...
                            <div className="grid sm:grid-cols-2 gap-8 my-12">
                                <div className="space-y-6">
                                    <div className="flex items-center gap-4 group">
                                        <div className="w-8 h-8 rounded-full bg-gold-400/20 flex items-center justify-center text-gold-400 group-hover:bg-gold-400 group-hover:text-olive-950 transition-all">✓</div>
                        ...
                        <div className="relative">
                            <div className="absolute -inset-4 bg-olive-500/10 blur-2xl rounded-full"></div>
                            <img src="/images/modern-warehouse.png" alt="Modern Depo ve Teknoloji" className="relative rounded-[60px] shadow-2xl border border-white/10" />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <div className="order-2 lg:order-1 relative group">
                            <div className="absolute inset-0 bg-gold-400/5 rounded-[60px] blur-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            <img src="/images/delivery-van-branded.png" alt="Lider Zeytincilik Filosu" className="relative rounded-[60px] shadow-2xl border border-white/5" />
                        </div>
                        <div className="order-1 lg:order-2">
                            ...
                            <div className="bg-white/5 p-8 rounded-[40px] border border-white/10 flex items-center gap-8 mb-10 hover:bg-white/10 transition-colors">
                                <img src="/images/retail-boxes-2.png" alt="Sevkiyat Hazırlığı" className="w-32 h-32 object-cover rounded-3xl shadow-2xl" />
                                <div>
            ...
            <section className="py-32">
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div className="md:col-span-2 md:row-span-2 overflow-hidden rounded-[40px] group border border-white/5 relative">
                        ...
                        <div className="overflow-hidden rounded-[40px] group h-72 border border-white/5 relative">
            ...
            <section className="py-32">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="bg-olive-900 rounded-[60px] p-8 md:p-20 text-white text-center relative overflow-hidden border border-white/10 shadow-3xl">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center gap-6">
                                <a href={`https://wa.me/${siteConfig.whatsapp}`} className="inline-flex items-center justify-center bg-gold-400 hover:bg-gold-500 text-olive-950 font-black uppercase tracking-[0.2em] text-sm px-12 py-5 rounded-2xl transition-all shadow-xl shadow-gold-500/20 active:scale-95">
                                    Teklif Alın
                                </a>
                                <a href={`tel:${siteConfig.phone.replace(/\s/g, '')}`} className="inline-flex items-center justify-center bg-white/5 hover:bg-white/10 text-white font-black uppercase tracking-[0.2em] text-sm px-12 py-5 rounded-2xl transition-all backdrop-blur-md border border-white/10 active:scale-95">
                                    Bizi Arayın
                                </a>
                            </div>
                        </div>
