                ...
                <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16 lg:h-24">
                    ...
                    <nav className="hidden lg:flex items-center gap-1">
                        {navLinks.map((link) => (
                            ...
                            >
                                <Link
                                    href={link.href}
                                    className="px-4 py-2 text-xs font-black uppercase tracking-[0.2em] text-olive-200 hover:text-gold-400 rounded-none hover:bg-white/5 transition-all flex items-center gap-1.5"
                                >
                                    {link.label}
                                    {link.children && (
                                ...
                                {link.children && openDropdown === link.label && (
                                    <div className="absolute top-full left-0 mt-2 w-72 bg-olive-900 rounded-none shadow-2xl border border-white/10 py-3 animate-fade-in z-50 overflow-hidden backdrop-blur-xl">
                    ...
                    <div className="flex items-center gap-4">
                        <a
                            ...
                            className="hidden lg:inline-flex items-center gap-3 bg-gold-400 hover:bg-gold-500 text-olive-950 px-8 py-3 rounded-none text-xs font-black uppercase tracking-widest transition-all hover:shadow-gold-500/20 shadow-lg active:scale-95"
                        >
